...
%
% entradas:
% ymeasured : Valores obserados/medidos;
% ypred     : Valores preditos;  
% k         : Número de permutações;
% n         : Grau do polonimio
%
%  saída  :
%   perm  : estrutura com 
...
% 
%  Filgueiras, P.R. et al. Chemom. Intel. Lab. Syst. 2014, 133, 33-41.
%
...
if pvalue > 0.05
    perm.Resul = 'Os residuos NÃO seguem uma tendência quadrática.';
    disp(perm.Resul)
else
    perm.Resul = 'Os residuos SEGUEM uma tendência quadrática.';
    disp(perm.Resul)
end
